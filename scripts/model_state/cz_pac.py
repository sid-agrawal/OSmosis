...
# ./cz_pac.py -f cz_pac.csv &&  cp  cz_pac.csv ~/neo4j/import/cz_pac.csv && python import_csv.py --file cz_pac.csv   
parser = argparse.ArgumentParser("cz_pac")
...
if __name__ == "__main__":
    ...
    # Make Proc1-PAC_1
        # PD
    pdd_id = model.add_pd_node("PAC1_P1")
    ...
    pdd_id2 = model.add_pd_node("PAC2_P1")
