...
# ./cz_cheri-static.py -f cz_cheri-static.csv &&  cp  cz_cheri-static.csv ~/neo4j/import/cz_cheri-static.csv && python import_csv.py --file cz_cheri-static.csv   
parser = argparse.ArgumentParser("cz_cheri-static")
...
if __name__ == "__main__":
    ...
    model.add_hold_edge(Permission.R, pdd_id, ResourceType.BUFF, crs_id, cres_id, [pd_id, pdd_id, "compiler+loader"])
