...
def get_vm_state(get_host: bool, guest_file: str, g2h_file: str, host_file: str):
    ...
    get_guest_host_mappings(fn=guest_file, phandle=phandle, g2h_file=g2h_file)
...
def get_guest_host_mappings(fn: str, phandle: pexpect.spawn, g2h_file: str):
    ...
    print(f"{len(gpa2hva)} entries written to {fn}")
...
def main():
    ...
    get_vm_state(
        get_host=False, guest_file=args.guest, g2h_file=args.g2h, host_file=args.host
    )
